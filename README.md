chell is a simple, self healing video portal that is meant to host a constant link between two offices.
...
```bash
git clone git@github.com:tamediadigital/chell.git
```
